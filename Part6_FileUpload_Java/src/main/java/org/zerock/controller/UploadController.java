...
public class UploadController {
	...
	public void uploadFormPost(MultipartFile[] uploadFile, Model model) {
		...
		String uploadFolder = "/Users/down/Develop/upload/tmp";
	...
	public ResponseEntity<byte[]> getFile(String fileName) {
		...
		File file = new File("/Users/down/Develop/upload/tmp" + fileName);
	...
	public ResponseEntity<Resource> downloadFile(@RequestHeader("User-Agent") String userAgent, String fileName) {
		...
		Resource resource = new FileSystemResource("/Users/down/Develop/upload/tmp" + fileName);
	...
	public ResponseEntity<String> deleteFile(String fileName, String type) {
		...
		try {
			file = new File("/Users/down/Develop/upload/tmp" + URLDecoder.decode(fileName, "UTF-8"));
